...
@InputType()
class EventLogCreateNestedManyWithoutUserActivitiesInput {
...
export { EventLogCreateNestedManyWithoutUserActivitiesInput as EventLogCreateNestedManyWithoutUserActivitiesInput };
